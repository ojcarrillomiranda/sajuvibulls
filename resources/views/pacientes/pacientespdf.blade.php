            ...
            <div class="row ">
                <div class="col show">
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <h3 id="paciente" class="text-black" style="margin-top: 80">Pacientes</h3>
                                ...
                                <tbody class="text-center">
                                    @foreach ($pacientes as $paciente)
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="{{ '../public/images/pacientes/' . $paciente->foto }}" style="width: 1cm;height:1cm;"></td>
                                            <td>{{ $paciente->representante->primer_nombre }} {{ $paciente->representante->primer_apellido }}
                                            </td>
