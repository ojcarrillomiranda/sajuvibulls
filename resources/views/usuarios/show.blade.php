                    ...
                    <div class="card-body">
                        <form action="/usuarios" method="post" enctype="multipart/form-data" class="p-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tipo_documento" value="{{ $usuario->user->tipo_documento }}"
                                    name="id" readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" value="{{ $usuario->user->apellido }}"
                                    name="nombre" readonly>
                            </div>
                            <div class="mb-3">
